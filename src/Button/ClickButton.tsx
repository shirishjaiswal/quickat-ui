...
type ButtonVariant =
  ...
  | 'gradient-blue' | 'gradient-green' | 'gradient-cyan' | 'gradient-teal' | 'gradient-lime'
  | 'gradient-red' | 'gradient-pink' | 'gradient-purple'
  | 'shadow-blue' | 'shadow-green' | 'shadow-cyan' | 'shadow-teal' | 'shadow-lime'
  | 'shadow-red' | 'shadow-pink' | 'shadow-purple'
  | 'outline-blue' | 'outline-dark' | 'outline-green' | 'outline-red' | 'outline-yellow' | 'outline-purple'
...
const VARIANT_STYLES: Record<ButtonVariant, string> = {
  ...
  // Gradient styles
  'gradient-blue': 'text-white bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 hover:bg-gradient-to-br',
  ...
  // Shadow styles
  'shadow-blue': 'text-white bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 shadow-lg shadow-blue-500/50',
  ...
  // Outline styles
  'outline-blue': 'text-blue-700 border border-blue-700 hover:bg-blue-800 hover:text-white',
  ...
  // Mixed colors
  'purple-blue': 'text-white bg-gradient-to-br from-purple-600 to-blue-500 hover:bg-gradient-to-bl',
